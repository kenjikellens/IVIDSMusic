...
class MainActivity : AppCompatActivity() {
    ...
    // OkHttpClient with 15-second timeouts for streaming and API proxying
    ...
    inner class AndroidAPI {
        ...
        @JavascriptInterface
        fun downloadTrack(videoId: String, title: String, artist: String, cover: String) {
            Log.d("IVIDS", "downloadTrack called: $artist - $title")
        }
    }
}
